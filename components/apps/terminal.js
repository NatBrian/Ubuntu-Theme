...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["about", "movies", "music", "pictures", "secrets", "kaomoji"],
            about: ["Nathanael_Brian", "linkedin.com/in/nathanael-brian-b47a73165"],
            movies: ["4Kvideo.mp4", "nature.mov", "coolVideo.mp4"],
            pictures: ["mountain_view.jpg", "vector.png", "space.jpg", "pikachu.gif"],
            secrets: ["<img class=' w-2/5' src='./images/memes/pow.webp' />"],
            kaomoji: ["٩(＾◡＾)۶", "(づ ◕‿◕ )づ", "༼ ༎ຶ ᆺ ༎ຶ༽", "ᕙ(⇀‸↼‶)ᕗ", "(ノಠ益ಠ)ノ彡┻━┻", "(シ_ _)シ"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">Brian@desktop</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/brian")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-author, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-author":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-author");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-author, todoist, trash, settings, sendmsg ]";
                }
                break;
            ...
            case "sudo":
                ...
                result = "<img class=' w-2/5' src='./images/memes/heh.jpeg' />";
                break;
            default:
                result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-author, todoist, trash, settings, sendmsg ]";
        }
