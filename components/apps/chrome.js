...
export class Chrome extends Component {
    ...
    goToHome = () => {
        this.setState({ url: this.home_url, display_url: "https://www.google.com/webhp?igu=1" });
        this.refreshChrome();
    }
    ...
    checkKey = (e) => {
        if (e.key === "Enter") {
            ...
            if (url.includes("https") || url.includes(".com") || url.includes(".net") || url.includes(".co") || url.includes(".org") || url.includes(".io")) {
                url = url;
            } else {
